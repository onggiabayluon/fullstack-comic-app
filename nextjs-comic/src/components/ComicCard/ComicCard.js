      ...
      <div className={cx("comic-card__right")}>
        {hasHeader && (
          <div className={cx("header")}>
            ...
            <span className={cx("timer", "light-text")}>
              ...
              <span className={cx("timer__text")}>
                {formatTimeAgo(created_date)}
              </span>
            </span>
          </div>
        )}
        ...
        <ul className={cx("comic-card__chapters")}>
          {chapters?.slice(0, LIMIT).map((chapter) => (
            ...
            >
              <li className={cx("chapter")}>C.{chapter.chapter_num}</li>
            </Link>
          ))}
        </ul>
      </div>
  ...
  return (
    <>
      <div className={cx("card__info-wrapper")}>
        <span className={cx("card__num")}>Chapter {props.chapter_num}</span>
        <span className={cx("card__date")}>
          {formatTimeAgo(props.created_date)}
        </span>
