function PictureGroupSkeleton({ error = false, className = '', width, height, hasIcon = true }) {
  return (
    <div
      role="status"
        ...
        {hasIcon && (
          <>
            {error ? (
              ...
              <svg
                className="mx-auto w-1/6 text-gray-200 dark:text-gray-600"
                xmlns="http://www.w3.org/2000/svg"
                aria-hidden="true"
                fill="currentColor"
                viewBox="0 0 640 512"
...
export default PictureGroupSkeleton
